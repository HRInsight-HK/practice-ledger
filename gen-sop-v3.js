  ...
  return makeDoc([
    ...
    makeTable(['角色', '人员', '系统账号', '密码', '核心职责'],
      [
        ...
        [{text:'行政',bold:true}, '莫青霖', 'admin', 'Zz741852', '处理问卷、登记人员信息、录入设备、跟踪状态'],
        [{text:'SSC',bold:true}, 'Zoe', 'hr', 'Zoe20260708', '录入薪资（本地不上云）、跟进反馈、办理入职/结算、账号管理'],
        [{text:'HRD',bold:true}, 'massie', 'manager', '4302055540j', '审批正式入职、查看全量数据、关注风险预警、账号管理'],
      ], [12, 15, 12, 12, 49]),
    emptyLine(),
...
function createLeadershipGuide() {
  return makeDoc([
    ...
    makeTable(['角色', '用户名', '密码', '人员'],
      [
        ['行政', 'admin', 'Zz741852', '莫青霖'],
        ['SSC', 'hr', 'Zoe20260708', 'Zoe'],
        ['HRD', 'manager', '4302055540j', 'massie'],
      ], [25, 25, 25, 25]),
    emptyLine(),
...
function createFullGuide() {
  return makeDoc([
    ...
    h3('6.2 行政登记（行政 莫青霖）'),
    bullet('登录管理后台：' + CLOUD_URL + '（admin / Zz741852）'),
    ...
    bullet('步骤5：登录（用户名 hr，密码 Zoe20260708），设置本地加密口令'),
    ...
    makeTable(['角色', '人员', '用户名', '密码'],
      [
        ['行政', '莫青霖', 'admin', 'Zz741852'],
        ['SSC', 'Zoe', 'hr', 'Zoe20260708'],
        ['HRD', 'massie', 'manager', '4302055540j'],
      ], [20, 25, 25, 30]),
    emptyLine(),
